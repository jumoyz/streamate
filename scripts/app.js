...
async function loadUserData() {
    try {
        ...
        document.getElementById('profileImage').src = currentUser.avatar_url || 'images/user_avatar.png';
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    <img src="${profile.avatar_url || 'images/user_avatar.png'}" class="profile-avatar mb-3">
                                    <h5>${profile.name}</h5>
